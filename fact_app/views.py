    ...
    def post(self,request,*args,**kwargs):
        ...
        if request.POST.get('id_modified'):
            ...
            try:
                ...
                messages.error(request,("Sorry the following erro has occured {e}"))
...
class AddCustomerView(LoginRequiredSuperuserMixim,View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        try:
            ...
            messages.error(request,f"Sorry our system is detcting the following issues {e}")
...
class InvoiceVisualizationView(LoginRequiredSuperuserMixim,View):
    """this views help to visualization the invoice"""
